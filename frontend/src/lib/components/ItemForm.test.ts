...
import type { Category, Tag, AttributeDefinition } from '$lib/types';
...
const tags: Tag[] = [
	...
	{ id: 2, name: '登山杖', category_id: 2, sort_order: 1 }
];
...
const attrDefs: AttributeDefinition[] = [
	...
	{ id: 3, key: 'warmth_rating', label: '保暖', attr_type: 'bar', config: '{"max":50}', category_scope: '', tag_scope: '', sort_order: 1 }
];
